...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "orderservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "orderservice API";

        private String description = "orderservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "orderservice";
